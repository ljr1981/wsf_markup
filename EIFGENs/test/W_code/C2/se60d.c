...
static const EIF_TYPE_INDEX egt_1_60 [] = {0xFF01,283,59,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_60 [] = {0xFF01,508,254,254,0xFFFF};
...
static const struct desc_info desc_60[] = {
	...
	{EIF_GENERIC(egt_13_60), 983, 0xFFFFFFFF},
};
void Init60(void)
{
	IDSC(desc_60, 0, 59);
	IDSC(desc_60 + 1, 1, 59);
	IDSC(desc_60 + 32, 260, 59);
}
