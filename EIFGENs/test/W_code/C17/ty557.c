...
extern EIF_TYPED_VALUE F557_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F557_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 556, Current, 0, 0, 3218);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(556, Current, 3218);
	RTIV(Current, RTAL);
