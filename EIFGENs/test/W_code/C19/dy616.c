...
extern EIF_TYPED_VALUE F616_3892(EIF_REFERENCE);
extern EIF_TYPED_VALUE F616_3893(EIF_REFERENCE);
extern void F616_3899(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F616_3902(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F616_3903(EIF_REFERENCE);
extern EIF_TYPED_VALUE F616_3904(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F616_3892 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 615, Current, 0, 0, 6666);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(615, Current, 6666);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F616_3893 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 615, Current, 0, 0, 6667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(615, Current, 6667);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F616_3899 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 615, Current, 0, 1, 6668);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(615, Current, 6668);
	RTIV(Current, RTAL);
...
void F616_3902 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 615, Current, 0, 1, 6669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(615, Current, 6669);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F616_3903 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 615, Current, 0, 0, 6670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(615, Current, 6670);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F616_3904 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 615, Current, 2, 1, 6671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(615, Current, 6671);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2884, "extend", Result))(Result, up1x);
		RTHOOK(9);
