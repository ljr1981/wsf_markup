...
extern EIF_TYPED_VALUE F644_3315(EIF_REFERENCE);
extern EIF_TYPED_VALUE F644_3316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F644_3317(EIF_REFERENCE);
extern EIF_TYPED_VALUE F644_3318(EIF_REFERENCE);
extern void F644_3319(EIF_REFERENCE);
extern void F644_6602(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F644_3315 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F644_3316 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F644_3317 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 643, Current, 0, 0, 4667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(643, Current, 4667);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F644_3318 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 643, Current, 0, 0, 4668);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(643, Current, 4668);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F644_3319 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 643, Current, 0, 0, 4669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(643, Current, 4669);
	RTIV(Current, RTAL);
...
void F644_6602 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 643, Current, 0, 6601);
	RTSA(dtype);
	RTME(dtype, 0);
