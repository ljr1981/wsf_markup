...
extern EIF_TYPED_VALUE F735_3324(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F735_3327(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F735_3329(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F735_3324 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 734, Current, 0, 1, 4745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(734, Current, 4745);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F735_3327 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 734, Current, 1, 1, 4746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(734, Current, 4746);
	{
...
void F735_3329 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 734, Current, 0, 1, 4747);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(734, Current, 4747);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	for (;;) {
		...
		RTHOOK(3);
		ur4_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2886, dtype))(Current, ur4_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
