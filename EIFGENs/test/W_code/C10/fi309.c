...
extern EIF_TYPED_VALUE F309_3311(EIF_REFERENCE);
extern void F309_6600(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F309_3311 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 308, Current, 0, 0, 4565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(308, Current, 4565);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F309_6600 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 308, Current, 0, 6599);
	RTSA(dtype);
	RTME(dtype, 0);
