...
extern EIF_TYPED_VALUE F400_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F400_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 399, Current, 0, 0, 3214);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(399, Current, 3214);
	RTIV(Current, RTAL);
