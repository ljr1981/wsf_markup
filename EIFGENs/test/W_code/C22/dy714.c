...
extern EIF_TYPED_VALUE F714_3892(EIF_REFERENCE);
extern EIF_TYPED_VALUE F714_3893(EIF_REFERENCE);
extern void F714_3899(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F714_3902(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F714_3903(EIF_REFERENCE);
extern EIF_TYPED_VALUE F714_3904(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F714_3892 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 713, Current, 0, 0, 6684);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(713, Current, 6684);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F714_3893 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 713, Current, 0, 0, 6685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(713, Current, 6685);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F714_3899 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 713, Current, 0, 1, 6686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(713, Current, 6686);
	RTIV(Current, RTAL);
...
void F714_3902 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 713, Current, 0, 1, 6687);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(713, Current, 6687);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F714_3903 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 713, Current, 0, 0, 6688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(713, Current, 6688);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F714_3904 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 713, Current, 2, 1, 6689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(713, Current, 6689);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu2_1 = tu2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2884, "extend", Result))(Result, uu2_1x);
		RTHOOK(9);
