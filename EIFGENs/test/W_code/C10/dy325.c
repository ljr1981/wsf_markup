...
extern EIF_TYPED_VALUE F325_3892(EIF_REFERENCE);
extern EIF_TYPED_VALUE F325_3893(EIF_REFERENCE);
extern void F325_3899(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F325_3902(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F325_3903(EIF_REFERENCE);
extern EIF_TYPED_VALUE F325_3904(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F325_3892 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 324, Current, 0, 0, 6636);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(324, Current, 6636);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F325_3893 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 324, Current, 0, 0, 6637);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(324, Current, 6637);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F325_3899 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 324, Current, 0, 1, 6638);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(324, Current, 6638);
	RTCC(arg1, 324, l_feature_name, 1, RTWCT(2897, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F325_3902 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 324, Current, 0, 1, 6639);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(324, Current, 6639);
	RTCC(arg1, 324, l_feature_name, 1, RTWCT(2897, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F325_3903 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 324, Current, 0, 0, 6640);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(324, Current, 6640);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F325_3904 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 324, Current, 2, 1, 6641);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(324, Current, 6641);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
