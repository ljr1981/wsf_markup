...
extern EIF_TYPED_VALUE F725_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F725_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 724, Current, 0, 0, 3222);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(724, Current, 3222);
	RTIV(Current, RTAL);
