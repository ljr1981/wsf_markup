...
extern EIF_TYPED_VALUE F565_3311(EIF_REFERENCE);
extern void F565_6600(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F565_3311 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 564, Current, 0, 0, 4577);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {FINITE}._invariant */
void F565_6600 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 564, Current, 0, 6599);
	RTSA(dtype);
	RTME(dtype, 0);
