...
extern EIF_TYPED_VALUE F830_3906(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F830_3907(EIF_REFERENCE);
extern EIF_TYPED_VALUE F830_3908(EIF_REFERENCE);
extern void F830_6613(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F830_3906 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 2, 1, 6774);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 6774);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2897, "item", arg1))(arg1)).it_c1);
...
/* {LIST}.after */
EIF_TYPED_VALUE F830_3907 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 829, Current, 0, 0, 6775);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 6775);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F830_3908 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 829, Current, 0, 0, 6776);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 6776);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2860, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F830_6613 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 829, Current, 0, 6612);
	RTSA(dtype);
	RTME(dtype, 0);
