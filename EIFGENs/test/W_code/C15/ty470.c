...
extern EIF_TYPED_VALUE F470_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F470_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 469, Current, 0, 0, 3216);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(469, Current, 3216);
	RTIV(Current, RTAL);
