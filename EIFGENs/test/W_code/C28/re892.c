...
extern EIF_TYPED_VALUE F892_3315(EIF_REFERENCE);
extern EIF_TYPED_VALUE F892_3316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F892_3317(EIF_REFERENCE);
extern EIF_TYPED_VALUE F892_3318(EIF_REFERENCE);
extern void F892_3319(EIF_REFERENCE);
extern void F892_6602(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F892_3315 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F892_3316 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F892_3317 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 891, Current, 0, 0, 4709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(891, Current, 4709);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F892_3318 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 891, Current, 0, 0, 4710);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(891, Current, 4710);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F892_3319 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 891, Current, 0, 0, 4711);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(891, Current, 4711);
	RTIV(Current, RTAL);
...
void F892_6602 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 891, Current, 0, 6601);
	RTSA(dtype);
	RTME(dtype, 0);
