...
extern EIF_TYPED_VALUE F627_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F627_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 626, Current, 0, 0, 3220);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(626, Current, 3220);
	RTIV(Current, RTAL);
