...
extern void F909_3391(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F909_3392(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F909_3391 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 908, Current, 0, 1, 4842);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(908, Current, 4842);
	RTCC(arg1, 908, l_feature_name, 1, RTWCT(2897, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F909_3392 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 908, Current, 1, 1, 4843);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(908, Current, 4843);
	{
...
body:;
	...
	for (;;) {
		...
		if (!tb3) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2880, dtype))(Current)).it_b);
			tb2 = (EIF_BOOLEAN) !tb3;
		}
		if (tb2) break;
		RTHOOK(9);
