...
extern EIF_TYPED_VALUE F463_3892(EIF_REFERENCE);
extern EIF_TYPED_VALUE F463_3893(EIF_REFERENCE);
extern void F463_3899(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F463_3902(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F463_3903(EIF_REFERENCE);
extern EIF_TYPED_VALUE F463_3904(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F463_3892 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 462, Current, 0, 0, 6654);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 6654);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F463_3893 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 462, Current, 0, 0, 6655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 6655);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F463_3899 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 462, Current, 0, 1, 6656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 6656);
	RTIV(Current, RTAL);
...
void F463_3902 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 462, Current, 0, 1, 6657);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 6657);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F463_3903 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 462, Current, 0, 0, 6658);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 6658);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F463_3904 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 462, Current, 2, 1, 6659);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(462, Current, 6659);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2884, "extend", Result))(Result, ub1x);
		RTHOOK(9);
