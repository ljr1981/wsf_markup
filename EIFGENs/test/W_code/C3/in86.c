...
extern EIF_TYPED_VALUE F86_1241(EIF_REFERENCE);
extern EIF_TYPED_VALUE F86_1242(EIF_REFERENCE);
extern EIF_TYPED_VALUE F86_1243(EIF_REFERENCE);
extern void F86_1244(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F86_1241 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 85, Current, 1, 0, 1257);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(85, Current, 1257);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1152, dtype))(Current, up1x);
	RTHOOK(3);
...
RTOID (F86_1242)
EIF_TYPED_VALUE F86_1242 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 85, Current, 0, 0, 1258);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(85, Current, 1258);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F86_1243)
EIF_TYPED_VALUE F86_1243 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 85, Current, 0, 0, 1259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(85, Current, 1259);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000086, 0,0); /* Result */
...
void F86_1244 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 85, Current, 0, 1, 1260);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(85, Current, 1260);
