...
extern EIF_TYPED_VALUE F476_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F476_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 475, Current, 0, 0, 3217);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(475, Current, 3217);
	RTIV(Current, RTAL);
