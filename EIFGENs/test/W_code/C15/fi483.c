...
extern EIF_TYPED_VALUE F483_3311(EIF_REFERENCE);
extern void F483_6600(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F483_3311 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 482, Current, 0, 0, 4573);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(482, Current, 4573);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F483_6600 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 482, Current, 0, 6599);
	RTSA(dtype);
	RTME(dtype, 0);
