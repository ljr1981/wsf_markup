...
extern EIF_TYPED_VALUE F795_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F795_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 794, Current, 0, 0, 3224);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(794, Current, 3224);
	RTIV(Current, RTAL);
