...
extern EIF_TYPED_VALUE F879_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F879_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 878, Current, 0, 0, 3226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(878, Current, 3226);
	RTIV(Current, RTAL);
