...
extern EIF_TYPED_VALUE F454_3315(EIF_REFERENCE);
extern EIF_TYPED_VALUE F454_3316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F454_3317(EIF_REFERENCE);
extern EIF_TYPED_VALUE F454_3318(EIF_REFERENCE);
extern void F454_3319(EIF_REFERENCE);
extern void F454_6602(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F454_3315 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F454_3316 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F454_3317 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 453, Current, 0, 0, 4643);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(453, Current, 4643);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F454_3318 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 453, Current, 0, 0, 4644);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(453, Current, 4644);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F454_3319 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 453, Current, 0, 0, 4645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(453, Current, 4645);
	RTIV(Current, RTAL);
...
void F454_6602 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 453, Current, 0, 6601);
	RTSA(dtype);
	RTME(dtype, 0);
