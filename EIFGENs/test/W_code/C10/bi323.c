...
extern EIF_TYPED_VALUE F323_3302(EIF_REFERENCE);
extern void F323_3305(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F323_6598(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F323_3302 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 322, Current, 0, 0, 4517);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(322, Current, 4517);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F323_3305 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 322, Current, 0, 1, 4518);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(322, Current, 4518);
	RTCC(arg1, 322, l_feature_name, 1, RTWCT(2851, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2867, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2859, 305))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F323_6598 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 322, Current, 0, 6597);
	RTSA(dtype);
	RTME(dtype, 0);
