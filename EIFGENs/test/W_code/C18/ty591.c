...
extern EIF_TYPED_VALUE F591_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F591_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 590, Current, 0, 0, 3219);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(590, Current, 3219);
	RTIV(Current, RTAL);
