...
extern EIF_TYPED_VALUE F446_3311(EIF_REFERENCE);
extern void F446_6600(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F446_3311 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 445, Current, 0, 0, 4571);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(445, Current, 4571);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F446_6600 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 445, Current, 0, 6599);
	RTSA(dtype);
	RTME(dtype, 0);
