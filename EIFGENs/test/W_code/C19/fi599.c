...
extern EIF_TYPED_VALUE F599_3311(EIF_REFERENCE);
extern void F599_6600(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F599_3311 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 598, Current, 0, 0, 4579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(598, Current, 4579);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F599_6600 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 598, Current, 0, 6599);
	RTSA(dtype);
	RTME(dtype, 0);
