...
extern EIF_TYPED_VALUE F683_3757(EIF_REFERENCE);
extern EIF_TYPED_VALUE F683_3760(EIF_REFERENCE);
extern void F683_6609(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F683_3757 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 682, Current, 0, 0, 5320);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(682, Current, 5320);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F683_3760 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 682, Current, 0, 0, 5321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(682, Current, 5321);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F683_6609 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 682, Current, 0, 6608);
	RTSA(dtype);
	RTME(dtype, 0);
