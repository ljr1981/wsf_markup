...
extern EIF_TYPED_VALUE F361_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F361_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 360, Current, 0, 0, 3213);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(360, Current, 3213);
	RTIV(Current, RTAL);
