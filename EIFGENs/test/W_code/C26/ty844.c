...
extern EIF_TYPED_VALUE F844_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F844_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 843, Current, 0, 0, 3225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(843, Current, 3225);
	RTIV(Current, RTAL);
