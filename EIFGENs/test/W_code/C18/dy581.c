...
extern EIF_TYPED_VALUE F581_3892(EIF_REFERENCE);
extern EIF_TYPED_VALUE F581_3893(EIF_REFERENCE);
extern void F581_3899(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F581_3902(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F581_3903(EIF_REFERENCE);
extern EIF_TYPED_VALUE F581_3904(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F581_3892 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 580, Current, 0, 0, 6660);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(580, Current, 6660);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F581_3893 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 580, Current, 0, 0, 6661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(580, Current, 6661);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F581_3899 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 580, Current, 0, 1, 6662);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(580, Current, 6662);
	RTIV(Current, RTAL);
...
void F581_3902 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 580, Current, 0, 1, 6663);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(580, Current, 6663);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F581_3903 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 580, Current, 0, 0, 6664);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(580, Current, 6664);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F581_3904 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 580, Current, 2, 1, 6665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(580, Current, 6665);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
