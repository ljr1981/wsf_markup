...
extern EIF_TYPED_VALUE F687_3161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F687_3161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 686, Current, 0, 0, 3221);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(686, Current, 3221);
	RTIV(Current, RTAL);
