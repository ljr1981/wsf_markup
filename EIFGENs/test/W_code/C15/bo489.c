...
extern EIF_TYPED_VALUE F489_3313(EIF_REFERENCE);
extern void F489_6601(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F489_3313 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 488, Current, 0, 0, 4603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(488, Current, 4603);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F489_6601 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 488, Current, 0, 6600);
	RTSA(dtype);
	RTME(dtype, 0);
