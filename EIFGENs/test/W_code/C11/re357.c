...
extern EIF_TYPED_VALUE F357_3757(EIF_REFERENCE);
extern EIF_TYPED_VALUE F357_3760(EIF_REFERENCE);
extern void F357_6609(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F357_3757 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 356, Current, 0, 0, 5296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(356, Current, 5296);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F357_3760 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 356, Current, 0, 0, 5297);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(356, Current, 5297);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) (ti4_1 <= ti4_2)) {
			...
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3118, dtype))(Current)).it_i4);
...
void F357_6609 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 356, Current, 0, 6608);
	RTSA(dtype);
	RTME(dtype, 0);
